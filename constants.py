...
# Sounds
popsound = pyglet.media.load("assets/pop.wav", streaming=False)
hoversound = pyglet.media.load("assets/hover.wav", streaming=False)
clicksound = pyglet.media.load("assets/click.wav", streaming=False)
yaysound = pyglet.media.load("assets/yay.wav", streaming=False)
startmusic = pyglet.media.load("assets/startmusic.wav", streaming=False)
gamemusic = pyglet.media.load("assets/gamemusic.wav", streaming=False)
playerSounds = [pyglet.media.load("assets/soundred.wav", streaming=False),
                pyglet.media.load("assets/soundorange.wav", streaming=False),
                pyglet.media.load("assets/soundyellow.wav", streaming=False),
                pyglet.media.load("assets/soundgreen.wav", streaming=False),
                pyglet.media.load("assets/soundblue.wav", streaming=False),
                pyglet.media.load("assets/soundpurple.wav", streaming=False)]
...
# define needed colors with RGB values
rgbColors = {
    "red": (234, 24, 19, 255,
            234, 24, 19, 255,
            234, 24, 19, 255,
